...
import { childrenMergeDevices } from "../../place-manage/component/FloatLeft/utils";
...
// 固有资源的元素和设备统计
export const statisticsInherent = () => {
...
// 删除临时资源要素
export const inherentDelete = (params) => {
  return request.delete(`/feature/inherent/delete/${params}`);
};
...
// 更新固有资源位置信息
export const updateIconPositionInherent = (params) => {
  return request.post(`/feature/inherent/updateIconPosition`, params);
};
// 获取固有资源要素信息详情
...
export const reSequence = (params) => {
  return request.put(`/feature/inherent/reSequence`, params);
};
